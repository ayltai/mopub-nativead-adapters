...
public abstract class BaseEventNative<T extends BaseStaticNativeAd> extends CustomEventNative {
    ...
    @VisibleForTesting
    @Override
    public abstract void loadNativeAd(@NonNull Context context, @NonNull CustomEventNative.CustomEventNativeListener customEventNativeListener, @NonNull Map<String, Object> localExtras, @NonNull Map<String, String> serverExtras);
